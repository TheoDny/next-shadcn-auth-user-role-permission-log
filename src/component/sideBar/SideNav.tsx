...
const SideNav = () => {
    ...
    return (
        <div className="md:w-52 z-40 bg-white h-screen flex-1 fixed border-r border-zinc-200 hidden md:flex">
            <div className="flex flex-col space-y-2 w-full">
                <Link
                    href="/"
                    className="flex flex-row items-center justify-center md:justify-start md:px-4 border-b border-zinc-200 h-12 w-full"
                >
                    <Image
                        src="/logo-full.png"
                        alt="logo"
